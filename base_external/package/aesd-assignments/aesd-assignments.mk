...
AESD_ASSIGNMENTS_VERSION = '4644cea7efbcf75254a459fae9e2fee15b8ecfda' # assignment-9 in assignments-3 repo
...
AESD_ASSIGNMENTS_CFLAGS += -DUSE_AESD_CHAR_DEVICE


define AESD_ASSIGNMENTS_BUILD_CMDS
	$(MAKE) $(TARGET_CONFIGURE_OPTS) CFLAGS="$(TARGET_CFLAGS) $(AESD_ASSIGNMENTS_CFLAGS)" -C $(@D)/server clean
	$(MAKE) $(TARGET_CONFIGURE_OPTS) CFLAGS="$(TARGET_CFLAGS) $(AESD_ASSIGNMENTS_CFLAGS)" -C $(@D)/server all
endef
